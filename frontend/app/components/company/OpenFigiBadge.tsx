...
export default function OpenFigiBadge({
  ...
  if (status === 'mismatch')
    return (
      <span className="px-1.5 py-0.5 text-[11px] font-medium bg-neg-500/15 text-neg-300 border border-neg-500/25 rounded cursor-help"
  ...
  if (status === 'not_found')
    return (
      <span className="px-1.5 py-0.5 text-[11px] font-medium bg-warn-500/15 text-warn-300 border border-warn-500/30 rounded cursor-help"
