...
import { BreakdownView, CategoryMathBreakdown, type BreakdownData } from '../momentum/signalBreakdown';
...
type BreakdownTarget = { companyId: number; date: string; name: string; ticker: string | null };

/**
 * "Why this company, on this day" — the full arithmetic behind one pick.
 *
 ...
 */
function BreakdownModal({ target, config, onClose }: {
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        console.warn('[daily-holdings] breakdown failed', e);
