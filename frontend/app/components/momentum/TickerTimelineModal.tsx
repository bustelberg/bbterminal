...
// The breakdown payload + its renderer now live in `signalBreakdown.tsx` so /schedule's
// Daily holdings can open the same view from a clicked row.
import { BreakdownView, type BreakdownData } from './signalBreakdown';
