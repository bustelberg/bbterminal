...
/** Small "i" affordance that pops a tooltip below itself. Self-positions
 * within the viewport and closes on any scroll so the fixed-positioned
 * tooltip doesn't float over the sticky header after its anchor row has
 * scrolled away.
 */
