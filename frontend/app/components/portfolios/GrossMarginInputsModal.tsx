...
const LINES: InputsLine<GrossMarginRow>[] = [
  { label: 'Gross profit', of: (r, y) => r.gross_profit[y] },
  { label: 'Revenue', of: (r, y) => r.revenue[y], muted: true },
];

export default function GrossMarginInputsModal({ target, portfolioName, benchTarget, benchLabel, onClose }: {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        console.warn('[bb:bench] gross-margin-inputs constituents:', e);
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-scrim/60 p-4"
      ...
      <div className="bg-card rounded-xl border border-neutral-800/40 shadow-xl w-[88vw] h-[84vh] flex flex-col"
        ...
        <div className="flex-1 overflow-auto px-6 py-4 space-y-5">
          <p className="text-[12px] text-fg-faint">Gross profit and revenue (millions, native currency). Margin = Gross Profit ÷ Revenue. A blank gross profit is a bank — no cost of goods sold, so no gross margin exists.</p>
