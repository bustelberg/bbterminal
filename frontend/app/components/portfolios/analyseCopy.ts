...
const en = {
  ...
  columnGroups: {
    ...
    onmoney: { label: 'How cash-flow IRR is built', hint: 'dated XIRR, shown cumulatively' },
  ...
  holdings: {
    ...
    weightNow: 'Weight (now)', opening: 'Beginwaarde (1 Jan)', valueNow: 'Value now', avgCapital: 'Capital invested',
    unrealised: 'Unrealised', realised: 'Realised', income: 'Income', result: 'Result', price: 'Koers', currency: 'Valuta',
    rest: 'Rest', moneyWeighted: 'Cash-flow IRR', instrumentReturn: 'Instrument return', contribution: 'Contribution',
  ...
  info: {
    contributionNote: 'result ÷ the book’s opening capital', moneyNote: 'true dated XIRR of purchases, sales, income and valuation — displayed over the actual holding period, never annualised.',
    avgCapitalWhat: (name: string) => `Capital actually committed to ${name} during this book year.`,
    avgCapitalNote: 'This is not time-weighted: it is the value held at the year’s opening plus purchases made during the year. A sale stays in Result as realised performance, so a sold position remains measurable.',
    avgCapitalHow: (capital: string) => `Opening value + purchases during the year\n\n= ${capital}`,
    resultWhat: (name: string) => `What ${name} made or lost in euros during this book year.`,
    resultNote: 'AIRS values the held position; realised sales and net dividends are added separately.',
    resultHow: (unrealised: string, realised: string, income: string, result: string) => `Unrealised + realised + net income\n\n${unrealised} + ${realised} + ${income} = ${result}`,
    ...
    moneyHow: (_result: string, _capital: string, pct: string) => `XIRR of dated opening value, purchases, sales, net income and final valuation\n\n= ${pct} over this position’s actual holding period (not annualised)`,
  ...
  row: {
    ...
    momentumNote: 'signal_engine mom_12_1, EUR', volNote: 'annualised standard deviation of monthly EUR returns, up to 5 years',
    ...
    volWhat: (name: string) => `How much ${name}'s price moves, annualised, over its available history (up to 5 years).`,
    ...
    betaNote: (benchmark: string) => `weekly EUR returns vs ${benchmark}, available history up to 5 years`,
  ...
  sold: {
    ...
    volTitle: (name: string) => `Annualised volatility of ${name} in EUR, using available history up to five years.`,
...
const nl: AnalyseCopy = {
  ...
  columnGroups: {
    ...
    onmoney: { label: 'Opbouw kasstroom-IRR', hint: 'XIRR op datums, cumulatief getoond' },
  ...
  holdings: {
    ...
    weightNow: 'Gewicht (nu)', opening: 'Beginwaarde (1 jan)', valueNow: 'Huidige waarde', avgCapital: 'Belegd kapitaal',
    unrealised: 'Ongerealiseerd', realised: 'Gerealiseerd', income: 'Inkomsten', result: 'Resultaat', price: 'Koers', currency: 'Valuta',
    rest: 'Rest', moneyWeighted: 'Kasstroom-IRR', instrumentReturn: 'Instrumentrendement', contribution: 'Bijdrage',
  ...
  info: {
    contributionNote: 'resultaat ÷ beginkapitaal van het boek', moneyNote: 'echte XIRR op aankoop-, verkoop-, inkomsten- en waarderingsdatums — getoond over de werkelijke aanhoudperiode, nooit geannualiseerd.',
    avgCapitalWhat: (name) => `Kapitaal dat gedurende dit boekjaar daadwerkelijk in ${name} is belegd.`,
    avgCapitalNote: 'Dit is niet tijdgewogen: het is de waarde aan het begin van het jaar plus de aankopen in het jaar. Een verkoop blijft als gerealiseerd rendement in Resultaat staan, zodat ook een verkochte positie meetbaar blijft.',
    avgCapitalHow: (capital) => `Openingswaarde + aankopen gedurende het jaar\n\n= ${capital}`,
    resultWhat: (name) => `Wat ${name} in euro’s verdiende of verloor gedurende dit boekjaar.`,
    resultNote: 'AIRS waardeert de aangehouden positie; gerealiseerde verkopen en netto dividend worden afzonderlijk toegevoegd.',
    resultHow: (unrealised, realised, income, result) => `Ongerealiseerd + gerealiseerd + netto inkomen\n\n${unrealised} + ${realised} + ${income} = ${result}`,
    ...
    moneyHow: (_result, _capital, pct) => `XIRR van openingswaarde, aankopen, verkopen, netto inkomsten en eindwaardering op hun datums\n\n= ${pct} over de werkelijke aanhoudperiode (niet geannualiseerd)`,
  ...
  row: {
    ...
    momentumNote: 'signal_engine mom_12_1, EUR', volNote: 'geannualiseerde standaarddeviatie van maandelijkse EUR-rendementen, tot maximaal 5 jaar',
    ...
    volWhat: (name) => `Hoe sterk de koers van ${name} op jaarbasis bewoog over de beschikbare historie, tot maximaal vijf jaar.`,
    ...
    betaNote: (benchmark) => `wekelijkse EUR-rendementen versus ${benchmark}, beschikbare historie tot maximaal 5 jaar`,
  ...
  sold: {
    ...
    volTitle: (name) => `Geannualiseerde volatiliteit van ${name} in EUR, op beschikbare historie tot maximaal vijf jaar.`,
