...
const LINES: InputsLine<CashReturnRow>[] = [
  { label: 'Non-curr. liabilities', of: (r, y) => r.noncurrent_liabilities[y] },
  { label: 'Total equity', of: (r, y) => r.total_equity[y] },
];

export default function InvestedCapitalInputsModal({ target, portfolioName, benchTarget, benchLabel, onClose }: {
