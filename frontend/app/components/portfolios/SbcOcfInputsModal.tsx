...
const LINES: { key: 'sbc' | 'ocf'; label: string; muted?: boolean }[] = [
  { key: 'sbc', label: 'Stock-based comp.' },
  { key: 'ocf', label: 'Operating cash flow', muted: true },
];
...
export default function SbcOcfInputsModal({ target, portfolioName, onClose }: {
  ...
  const rows = useMemo(() => {
    const get: Record<SortKey, (r: SbcOcfRow) => number | string | null | undefined> = {
